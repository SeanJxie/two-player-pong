...
class PongApplication(arcade.Window):
    ...
    def paddle_movement(self):
        if self.up1 and self.paddle_pos_1[1] + settings.PADDLE_SIZE[1] / 2 < settings.WINDOW_SIZE[1]:
            self.paddle_pos_1[1] += settings.PADDLE_MOVE_SPEED

        if self.down1 and self.paddle_pos_1[1] - settings.PADDLE_SIZE[1] / 2 > 0:
            self.paddle_pos_1[1] -= settings.PADDLE_MOVE_SPEED

        if self.up2 and self.paddle_pos_2[1] + settings.PADDLE_SIZE[1] / 2 < settings.WINDOW_SIZE[1]:
            self.paddle_pos_2[1] += settings.PADDLE_MOVE_SPEED

        if self.down2 and self.paddle_pos_2[1] - settings.PADDLE_SIZE[1] / 2 > 0:
            self.paddle_pos_2[1] -= settings.PADDLE_MOVE_SPEED
